 ...
 * en GLUT, se crea una fuente de luz, y un material */
 ...
 /* Nombre:   Ramirez Hernandez Jose Angel Jair
	Grupo :   06
	Practica: Numero 1
	Version Vs: 2015*/
...
void init(void) //init establecer los parametros iniciales siempre siempre se pone
{
...
void reshape(int w, int h)//Establece nuestra ventana donde se va a ver la imagen
{
	 if (!h)
		return;
