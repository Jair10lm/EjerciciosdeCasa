...
//con la tecla Y se mueven los Dedos de la mano derecha
//con la tecla U se mueve el Pulgar
//Con la tecla I se mueve los Dedos de la mano Izquierda
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix(); //Muslo Izquierdo

	glTranslatef(-10.5, -22, 0);
	glScalef(5, 10, 5);
	prisma();

	glPopMatrix();

	glPushMatrix(); //Muslo Derecho

	glTranslatef(-19.5, -22, 0);
	glScalef(5, 10, 5);
	prisma();

	glPopMatrix();

	glPushMatrix(); //Rodilla Izquierdo

	glTranslatef(-10.5, -28, 0);
	glScalef(5, 2, 5);
	prisma();

	glPopMatrix();

	glPushMatrix(); //Rodilla Derecho

	glTranslatef(-19.5, -28, 0);
	glScalef(5, 2, 5);
	prisma();

	glPopMatrix();

	glPushMatrix(); //Tibia Izquierdo

	glTranslatef(-10.5, -32.5, 0);
	glScalef(5, 7, 5);
	prisma();

	glPopMatrix();

	glPushMatrix(); //Tibia Derecho

	glTranslatef(-19.5, -32.5, 0);
	glScalef(5, 7, 5);
	prisma();
	...
	glTranslatef(-25, 3, 0); //estamos en (-2.5, 1.25, 0)
	...
	//Dibujar el antebrazo izquierdo
	...
	//dibujar el dedo indice izquierda
	glTranslatef(-4, 1.6, 0); //estamos en (-2.5, 1.25, 0)
	glRotatef(angIndiceIzquierdo, 0, 1, 0);
	...
	//Dibujar dedo grosero izquierdo xD
	...
	//Segunda Falange del dedo meeñique izquierdo
	glTranslatef(-2, 0, 0); //estamos en (-2.5, 1.25, 0)
	glRotatef(angIndiceIzquierdo, 0, 0.5, 0);
	...
	//Segunda falange del dedo anular izquierdo
	...
	//Segunda falange del dedo grosero izquierdo
	glTranslatef(0, 1.2, 0); //estamos en (-2.5, 1.25, 0)
	glRotatef(angIndiceIzquierdo, 0, 0.5, 0);
	...
	//segunda falange del dedo indice izquierdo
	...
	//tercer falange del dedo indice izquierdo
	...
	//tercer falange del dedo grosero izquierdo
	glTranslatef(0, -1.2, 0); //estamos en (-2.5, 1.25, 0)
	glRotatef(angIndiceIzquierdo, 0, 1, 0);
	...
	//tercer falange del dedo anular izquierdo
	glTranslatef(0, -1.2, 0); //estamos en (-2.5, 1.25, 0)
	glRotatef(angNada, 0, 0, 0);
	...
	//tercer falange del dedo meñique izquierdo
...
void keyboard ( unsigned char key, int x, int y )  // Create Keyboard Function
{
	switch ( key ) {
		...
		case 'U': //Rota el Pulgar en x hacia atraz con limite de 0 grados
			...
			break;
		case 'i': //Rota el pulgar en x hacia delante con limite de 45 grados	
			if (angIndiceIzquierdo < 35) {
				angIndiceIzquierdo += 0.5f;
				printf("%f ", angIndiceIzquierdo);
			}
			break;
		case 'I': //Rota el Pulgar en x hacia atraz con limite de 0 grados
			if (angIndiceIzquierdo > 0) {
				angIndiceIzquierdo -= 0.5f;
				printf("%f ", angIndiceIzquierdo);
			}
			break;
