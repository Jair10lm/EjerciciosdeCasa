...
#include "Main.h"
// la animacion comienza al presionar la letra o
float transZ = -5.0f;
float transX = 0.0f;
float angleX = 0.0f;
float angleY = 0.0f;
...
int maxSteps = 3000;
int currSteps = 0;
int FrameIndex = 8; // Frame final fijado por nosotros
bool play = false;
int playIndex = 0;
...
void InitGL(void)     // Inicializamos parametros
{
	...
	KeyFrame[5].pulgar = 90; //Amor y paz
	KeyFrame[5].indice = 0;
	KeyFrame[5].medio = 0;
	...
	KeyFrame[7].pulgar = 0;	//Rockera
	KeyFrame[7].indice = 0;
	KeyFrame[7].medio = 90;
	KeyFrame[7].anular = 90;
	KeyFrame[7].menique = 0;

	KeyFrame[8].pulgar = 0; //OK
	KeyFrame[8].indice = 90;
	KeyFrame[8].medio = 90;
	KeyFrame[8].anular = 90;
	KeyFrame[8].menique = 90;
