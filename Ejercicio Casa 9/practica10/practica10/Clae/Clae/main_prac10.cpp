...
//************************************************************//
//************************************************************//
//************** Alumno (s): Ramirez Hernadnez Jose Angel Jair**//
//*************		Visual Studio 2017		******************//
//*************			Ejercicio en Casa		*************//
//**************		Figura en 3D		*****************//
//***********************************************************//
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	pintaTexto(-12, 12.0, -14.0, (void *)font, "Ejercicio en casa 10");
	pintaTexto(-12, 10.5, -14, (void *)font, "Figura en 3D");
	glColor3f(1.0, 1.0, 1.0);
	glEnable(GL_LIGHTING);
	glEnable(GL_TEXTURE_2D);
...
int main(int argc, char** argv)   // Main Function
{
	...
	glutCreateWindow("Ejercicio en Casa 10"); // Nombre de la Ventana
